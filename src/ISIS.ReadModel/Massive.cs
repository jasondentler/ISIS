...
{
    /// <summary>
    /// Rob Conery's massive dynamic data framework
    /// </summary>
    /// <remarks>Source: https://github.com/robconery/massive 
    /// License: Emailed Rob... He says New BSD.
    /// </remarks>
    ...
    public abstract class DynamicModel : DynamicObject
    {
        ...
        /// </summary>
        public IEnumerable<object> All(string where = "", string orderBy = "", int limit = 0, params object[] args)
        {
